...
photoRoll = Image.create([
  {
    ...
    map: {"green-velvet-dress":["<area alt='green-velvet-dress' shape='poly' coords='280, 380, 277, 356, 300, 270, 390, 233, 468, 253, 481, 239, 475, 291, 539, 325, 564, 424, 548, 435, 544, 421, 533, 423, 532, 464, 553, 532, 564, 605, 562, 647, 573, 713, 567, 865, 454, 852, 399, 860, 357, 875, 355, 875, 356, 836, 338, 741, 339, 659, 344, 611, 353, 553, 343, 506, 322, 452, 338, 393, 290, 364' />"]}
  }
])